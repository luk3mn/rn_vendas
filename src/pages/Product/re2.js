  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.products}>
        <Image style={styles.images} source={require('../../images/re2.png')} resizeMode='contain' />
        <Text style={styles.productName}>Resident Evil 2</Text>
        <Text style={styles.productName}>R$ 109,90</Text>
        <Text style={styles.productName}>Pagamento: 5 x R$ 21,98</Text>
      </View>
      <TouchableOpacity
        style={styles.cart}
        onPress={() => navigation.navigate('Cart', {product: 'Resident Evil 2'})}
      >
