  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.products}>
        <Image style={styles.images} source={require('../../images/the_last_of_us_2.png')} resizeMode='contain' />
        <Text style={styles.productName}>The Last of US Part 2</Text>
        <Text style={styles.productName}>R$ 129,90</Text>
        <Text style={styles.productName}>Pagamento: 5 x R$ 25,98</Text>
      </View>
      <Button 
        title='Adicionar Item'
        onPress={() => navigation.navigate('Cart', {product: 'The Last of Us - Part 2'})}
      />
      <Button 
